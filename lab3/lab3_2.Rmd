...
class(hot_springs$scientist)   #The class is character.

#Change it to factor
hot_springs$scientist <- as.factor(hot_springs$scientist)

#Levels of the Scientist factor variable 
...
#Yes, it changed from character to factors (catergorical variable).
...
#What are the levels of the springs column?
...
#The dimensions are 1440 (rows) x 13 (columns).
```
