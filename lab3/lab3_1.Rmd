...
## PN: We are identifying the position of the object withing the vector.

```{r}
#Will not work if you pull "Wednesday"
...
#The column names are: Sex, Length, and Weight. 
...
```{r}
#The hbirds df dimensions are 3 x 3. 
```
...
# str_to_lower("Sex")
# [1] "sex"
# str_to_lower("I'm Having FUN")
# [1] "i'm having fun"
# str_to_title("I'm Having FUN")
# [1] "I'm Having Fun"
...
# # 1st row, 3rd col
# hbirds[1, 3]
# #Rows 1 thru 3 & Columns 1 thru 3
# hbirds[1:3]
...
write.csv(hbirds,"black.csv",row.names = FALSE) 
